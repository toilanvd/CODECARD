...
document.getElementById("problems-list-table").innerHTML = 
	httpGet("http://"+hostname+":"+port+"/getFreetrainingProblemList");

document.getElementById("missions-list-table").innerHTML = httpGet("http://"+hostname+":"+port+"/getMissionsList");