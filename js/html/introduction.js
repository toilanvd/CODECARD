...
// 		if(combatid != "") window.location.href = "http://"+hostname+":"+port+"/combat/"+combatid;
// 	}, 5000);
...
var document_presentation =	"<object data='../introduction.pdf' type='application/pdf' class='document-presentation'/><a href='https://docs.google.com/viewerng/viewer?url=http://"+hostname+':'+port+"/introduction.pdf'>Read introduction</a></object>\n";
document.getElementById("introduction-document").innerHTML = document_presentation;