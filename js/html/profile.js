...
document.getElementById("change-username").setAttribute("action","http://"+hostname+":"+port+"/change_username");

document.getElementById("change-password").setAttribute("action","http://"+hostname+":"+port+"/change_password");